    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ':libraryId/series/:seriesId/book/:volumeId/notes',
            pathMatch: 'full',
            loadComponent: () => import('../app/series-detail/_components/chapter-notes/chapter-notes.component').then(c => c.ChapterNotesComponent)
          },
          {
